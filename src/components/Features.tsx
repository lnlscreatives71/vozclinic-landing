...
type IconName = 'chat' | 'calendar' | 'bell' | 'globe' | 'shield' | 'chart';
...
// tiles 4 & 5 equal (col-span-3 each)
const colSpans = ['lg:col-span-4', 'lg:col-span-2', 'lg:col-span-2', 'lg:col-span-4', 'lg:col-span-3', 'lg:col-span-3'];
const tealBg = [true, false, false, true, false, false];
